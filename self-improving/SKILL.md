...
Memory lives in `~/.hermes/skills/self-improving/` with tiered structure.

```
~/.hermes/skills/self-improving/
...
- Stores preferences in local files (`~/.hermes/skills/self-improving/`)
- Reads its own memory files on activation

This skill NEVER:
- Accesses calendar, email, or contacts
- Makes network requests
- Reads files outside `~/.hermes/skills/self-improving/`
