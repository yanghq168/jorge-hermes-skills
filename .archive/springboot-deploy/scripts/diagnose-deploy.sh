#!/bin/bash
# diagnose-deploy.sh — one-shot post-deploy health check
# Usage:  ./diagnose-deploy.sh <host-alias> <port> [log-path]
# Example: ./diagnose-deploy.sh jorge-remote 8081 /home/ruoyi/logs/teleSystem.out
